            ...
            <div class="login-page">
                <div class="form">
                    ...
                    <form class="login-form">
                        ...
                        <p style="background-color: rgb(231 36 36);margin-top: 3px;color: white;font-family: Cambria;">Log In failed!!</p>
...
<style scoped>
    ...
    body {
        background: #1d68a7; /* fallback for old browsers */
        background: -webkit-linear-gradient(right, #1d68a7, #00acc1);
