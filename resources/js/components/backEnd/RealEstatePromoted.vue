                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <table class="table table-striped">
                            ...
                            <!--Table body-->
                            <tbody >
                            <template v-for="list in Promoted">
                                <tr>
                                    ...
                                    <td>
                                        <label class="toggleSwitch nolabel" >
                                            <input :id="`${list.promoteId}`" type="checkbox"  @click="check(list.promoteId)" :checked="`${list.disable === 'true'?true:false}`">
                                            <span>
                                            <span>OFF</span>
                                            <span>ON</span>
                                            </span>
...
<script>
    export default {
        ...
        methods:{
            ...
            Dodelete(id){
                axios.get('api/DeletePromote/'+id).then(response => {
            ...
            check(id){
                ...
                axios.get('api/disablePromote/'+id+'/'+checkbox.checked).then(response => {
                    console.log(response.data)
                }).catch(err => {
                    console.log(err);
                });
