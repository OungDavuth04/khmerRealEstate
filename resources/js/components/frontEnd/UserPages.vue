                    ...
                    <div class="panel-body">
                        <div class="bg-color">
                            <div class="form-group">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Promote Product</h5>
                                        ...
                                        <template v-for="item in promoteData">
                                            <div class="card" style="width: 16.4rem; margin: 5px;">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text" v-text="item.price"></p>
                                                    <div class="btn-group">
                                ...
                                <div class="parent">
                                    <div v-for="item in upload" class="item">
                                        <div class="card" style="width: 16.4rem; margin: 5px;">
                                            <img class="card-img-top":src="item.images[0].image" alt="Card image cap">
                                            <div class="card-body">
                                                <h5 class="card-title" v-text="item.title" style="color:#0b75c9; ;"></h5>
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" @click="EditPost(item.upId)"> Edit</a>
                                                        <a class="dropdown-item" data-toggle="modal" data-target="#exampleModal">Delete</a>
                                                        <a class="dropdown-item"  @click="promote(item.upId)">Promote Product</a>
                                                    </div>
                                                    <button class="btn1" @click="promote(item.upId)"> Promote </button>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Comfirme Your Delete</h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-primary" @click="Do_delete(item.upId)">Ok</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
